...
<body>
    ...
    <form action="create.php" method="post">
        ...
        <input type="number" id="distance" name="distance" min="0" step="0.1" required><br><br>
        ...
        <input type="number" id="height_difference" name="height_difference" min="0" required><br><br>
...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['button'])) {
        if (isset($_POST['name']) && isset($_POST['difficulty']) && isset($_POST['distance']) && isset($_POST['duration']) && isset($_POST['height_difference'])) {
            ...
            try {
                $stmt = $dbh->prepare("INSERT INTO hiking (name, difficulty , distance, duration, height_difference) VALUES (:name, :difficulty , :distance, :duration , :height_difference)");
